...
#Mau recode izin ke nomor 0823-8623-4828
...
echo $indigo"*"     $yellow"Author  : MiSetya"
echo $indigo"*"     $yellow"Team    : Light Cyber Indonesia"
echo $indigo"*"     $yellow"Contact : 0823-8623-4828"
echo $indigo"==================================================================="
echo
...
clear
echo
figlet -f future Bucin by Alpinskay | lolcat
echo
echo
echo
sleep 0.1
